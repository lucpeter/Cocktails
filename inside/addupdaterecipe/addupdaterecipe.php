...
<html lang="en-US">
    ...
    if(isset($_GET['id']))
    {
        echo '<form method="post" action="recipe_submit.php?id=' . $_GET['id'] . '">';
    }
                else 
                {
                    echo '<form method="post" action="recipe_submit.php">';
                }
                    ?>
                    <fieldset id="personalInformation">
                        ...
                        <input readonly id="author" type="text" name="email" value="' . $cocktailAuthorEmail . '">';
